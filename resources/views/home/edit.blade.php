                ...
                <div class="card-header">{{ __('編集画面') }}
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <input class="form-check-input " type="radio" name="gender" id="gender" value="男性" {{ old('gender','男性') == '男性' ? 'checked' : '' }}/>   
                                <label class="form-check-label" for="gender">男性</label>
                                
                                <input class="form-check-input " type="radio" name="gender" id="gender" value="女性" {{ old('gender','女性') == '女性' ? 'checked' : '' }}/>     
                                <label class="form-check-label" for="gender">女性</label>
                                <input class="form-check-input " type="radio" name="gender" id="gender"  value="選択なし" {{ old('gender','選択なし') == '選択なし' ? 'checked' : '' }}/>    
